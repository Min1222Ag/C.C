...
: ${AMENT_CURRENT_PREFIX:="/home/pi/C.C/test/RobotVision/install/motor_pubsub"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_pubsub/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_pubsub/environment/path.sh"
