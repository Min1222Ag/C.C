...
interfaces__msg__Stop__are_equal(const interfaces__msg__Stop * lhs, const interfaces__msg__Stop * rhs)
{
  ...
  // lspeed
  if (lhs->lspeed != rhs->lspeed) {
    return false;
  }
  // rspeed
  if (lhs->rspeed != rhs->rspeed) {
    return false;
  }
  return true;
}
  ...
  interfaces__msg__Stop * output)
{
  ...
  // lspeed
  output->lspeed = input->lspeed;
  // rspeed
  output->rspeed = input->rspeed;
  return true;
}
...
interfaces__msg__Stop__create()
{
  ...
  interfaces__msg__Stop * msg = (interfaces__msg__Stop *)allocator.allocate(sizeof(interfaces__msg__Stop), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__Stop));
  bool success = interfaces__msg__Stop__init(msg);
  if (!success) {
...
interfaces__msg__Stop__destroy(interfaces__msg__Stop * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    interfaces__msg__Stop__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
interfaces__msg__Stop__Sequence__init(interfaces__msg__Stop__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__Stop * data = NULL;

  if (size) {
    data = (interfaces__msg__Stop *)allocator.zero_allocate(size, sizeof(interfaces__msg__Stop), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__Stop__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__Stop__fini(&data[i - 1]);
      }
...
interfaces__msg__Stop__Sequence__fini(interfaces__msg__Stop__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__Stop__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__Stop__Sequence * array = (interfaces__msg__Stop__Sequence *)allocator.allocate(sizeof(interfaces__msg__Stop__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__Stop__Sequence__init(array, size);
  if (!success) {
...
interfaces__msg__Stop__Sequence__destroy(interfaces__msg__Stop__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces__msg__Stop__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interfaces__msg__Stop__Sequence__are_equal(const interfaces__msg__Stop__Sequence * lhs, const interfaces__msg__Stop__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__Stop__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__msg__Stop__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__Stop);
    interfaces__msg__Stop * data =
      (interfaces__msg__Stop *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__Stop__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__msg__Stop__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__msg__Stop__copy(
